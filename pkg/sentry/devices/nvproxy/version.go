		...
		v535_104_05 := func() *driverABI {
			...
			return &driverABI{
				...
				controlCmd: map[uint32]controlCmdHandler{
					...
					nvgpu.NV9096_CTRL_CMD_SET_ZBC_COLOR_CLEAR:                              ctrlHandler(rmControlSimple, nvconf.CapVideo|nvconf.CapGraphics),
					nvgpu.NV9096_CTRL_CMD_GET_ZBC_CLEAR_TABLE_SIZE:                         ctrlHandler(rmControlSimple, nvconf.CapVideo|nvconf.CapGraphics),
					nvgpu.NV9096_CTRL_CMD_GET_ZBC_CLEAR_TABLE_ENTRY:                        ctrlHandler(rmControlSimple, nvconf.CapVideo|nvconf.CapGraphics),
				...
				allocationClass: map[nvgpu.ClassID]allocationClassHandler{
					...
					nvgpu.ADA_A:                      allocHandler(rmAllocSimple[nvgpu.NV_GR_ALLOCATION_PARAMETERS], nvconf.CapVideo),
				...
				getStructs: func() *driverABIStructs {
					return &driverABIStructs{
						...
						controlStructs: map[uint32][]DriverStruct{
							...
							nvgpu.NV9096_CTRL_CMD_SET_ZBC_COLOR_CLEAR:                              simpleDriverStruct("NV9096_CTRL_SET_ZBC_COLOR_CLEAR_PARAMS"),
